	...
	for(let r=0; r<rows; r++){
		for(let c=0; c<columns; c++){
			...
			if(board[r][c] === 8192 && is8192Exist == false){
				alert("YOU ARE GENIUS! YOU HAVE REACHED 8192!");
				is8192Exist = true;
			}
		}
	}
...
//document of the user on where the user will start to touch
...
document.addEventListener("touchmove",(e) =>{
	...
	e.preventDefault(); //this line prevens the default behavior during the user swipes the tile causing scroll (this line disables scrolling);
